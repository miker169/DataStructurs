...
function Graph() {
    ...
    var initializeColor = function initializeColor() {
        var color = [];
        for (var i = 0; i < vertices.length; i++) {
    ...
    this.bfs = function (v) {
        var color = initializeColor(),
            ...
            d = [],
            // declare d which represents the distances
    ...
    var dfsVisit = function dfsVisit(u, color, callback) {
    ...
    this.DFS = function () {
        var color = initializeColor(),
            ...
            f = [],
            p = [],
            // declare d f and p arrays and intialise
        time = 0;
    ...
    var DFSVisit = function DFSVisit(u, color, d, f, p) {
